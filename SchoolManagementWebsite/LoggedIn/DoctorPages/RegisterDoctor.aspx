<%@ Page Title="" Language="C#" MasterPageFile="~/AuthorizedPages.Master" AutoEventWireup="true" CodeBehind="RegisterDoctor.aspx.cs" Inherits="SchoolManagementWebsite.LoggedIn.DoctorPages.RegisterDoctor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Вписване на доктор
    </h2>
    <table class="BigText">
        <tr>
            <td>Собствено име :
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="register" ValidationGroup="Register" CssClass="bigButton BigText" Text="Вписване" OnClick="register_Click" runat="server" />
            </td>
        </tr>
    </table>
